...
public class BinarySearchTree<K extends Comparable<K>> {
	...
	/**
	 * Ability to say whether tree is empty or not returning value in order if not
	 * empty
	 */
	...
	/**
	 * Ability to search the whole tree for given element Return the flag data after
	 * searching
	 */
